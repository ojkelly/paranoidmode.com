...
## **Some things you might not know that will help you**
  ...
  - In `Tails` and other Linux terminals to copy text from the terminal you use `Shift-Ctrl-C` and `Shift-Ctrl-V`
...
[Pull Requests]: https://github.com/ojkelly/paranoidmode.com/pulls
